  ...
  return (
    <div className="m-auto max-w-[1080px] my-16 mt-24">
      ...
      <p className="mt-10 text-sm leading-7 text-textGray">
        ...
        قهوه به خصوص پیشنهاد کنیم ممکن نیست. به این دلیل که بسته به میزان فعالیت
        شما، باید میزان کافئین مورد انتظارتون رو مشخص کنید.
      </p>
      ...
      <p className="mt-4 text-sm leading-7 text-textGray">
        ...
        افزایش بده. این افزایش باعث میشه خون بیشتری سمت ماهیچه های شما بره و این
        میزان شادابی شما رو هنگام ورزش افزایش میده. افزایش فشار خون و انرژی باعث
        میشه روند کاهش وزن شما هم افزایش پیدا کنه و روند لاغری شما افزایش پیدا
        کنه.
      </p>
      ...
      <p className="mt-10 text-sm leading-7 text-textGray">
        ...
        خوردن اون ها احساس سر زندگی میکنید. اما پیدا کردن قهوه مناسب برای خودتون
        ممکنه یکم دشوار باشه. باید قهوه های مختلفی رو تست کنید تا به سلیقه مورد
        نظر خودتون برسید.
      </p>
      ...
      <p className="mt-10 text-sm leading-7 text-textGray">
        ...
        جدی برای شما مثل توهم به وجود بیاره و روز بعدی شما رو هم تحت تاثیر قرار
        بده. بهترین زمان برای استفاده قهوه عصر و قبل از باشگاهه. این مدت بهتره
        که ۴۵ دقیقه قبل از رفتن یا پرداختن به اون ورزش باشه.
      </p>
      <p className="mt-10 text-sm leading-7 text-textGray">
